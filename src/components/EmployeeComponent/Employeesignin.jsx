...
import Nav from "../Nav";
import img1 from "../../assets/signinemployee.avif";
...
const Signin = () => {
  ...
  const signinuser = () => {
    ...
    dispatch(asyncemployeesignin(newuser));
    navigate("/employee/dashboard");
  };

  useEffect(() => {
    isAuth && navigate("/employee/dashboard");
  }, [isAuth]);

  return (
    <>
      <Nav />
      <div className="flex justify-center  h-screen items-center mt-10 sm:mt-0 gap-2">
        ...
        <div className="thisform w-[35vw] text-center flex flex-col items-center ">
          <div className="textall mb-4 relative  sm:mb-0">
            ...
            <img
              className="absolute right-[3%] bottom-[45%] sm:w-[20vh] sm:bottom-[55%]"
          ...
          <p className="sm:w-56 text-md my-4 -ml-2">
            New User?{" "}
            <Link to="/employee/signup" className="text-[#00A5EC]">
              Register
            </Link>
          </p>
        </div>
